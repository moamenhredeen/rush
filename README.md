...
- Interactive input with line editing, persistent history, Tab completion, and syntax highlighting
...
- Source-located syntax diagnostics for command strings and script files
